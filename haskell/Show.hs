{-# LANGUAGE KindSignatures, TypeSynonymInstances,
  FlexibleInstances, TypeOperators, UndecidableInstances,
  DefaultSignatures, FlexibleContexts, DeriveGeneric, DeriveAnyClass
  #-}
...
instance (GShow a, Constructor g) => GShow (C1 g a) where
  shows1 _ c@(M1 a) = showString "(" .
                      ...
                      showString ")"
    where wrapRecord :: ShowS -> ShowS
          wrapRecord s | conIsRecord c =
